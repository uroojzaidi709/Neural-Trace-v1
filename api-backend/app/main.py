...
from .services.scapy_sniffer import scapy_background_task  
from .services.pcap_replay import router as pcap_router     
...
async def lifespan(app: FastAPI):
    ...
    asyncio.create_task(scapy_background_task())  
