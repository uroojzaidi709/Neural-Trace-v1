...
==========================
Loads trained XGBoost model and serves predictions via FastAPI.
"""
...
# FIX: Model file is "model (1).pkl" not "model.pkl"
_candidates = [
    os.path.join(MODEL_DIR, "model.pkl"),
    os.path.join(MODEL_DIR, "model (1).pkl"),
]
...
# FIX: Correct unicode em-dash in Web Attack class names
# Your label_encoder has: "Web Attack – Brute Force" (en-dash U+2013)
RISK_MAP = {
    "BENIGN":                        1,
    "Bot":                           8,
    "DDoS":                          9,
...
app = FastAPI(title="Neural-Trace ML Classifier", version="1.0.0")
...
def predict(payload: FlowFeatures):
    if MODEL is None:
        import random
        mock_labels = ["SSH-Patator", "DDoS", "PortScan", "DoS Hulk", "FTP-Patator", "BENIGN"]
